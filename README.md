...
**UPDATE**: HGT is the current SOTA result on the [*Stanford OGBN-MAG, OGBN-Products dataset*](https://ogb.stanford.edu/docs/leader_nodeprop/). The codes are also avaiable in this repo.
