...
**UPDATE**: HGT is Currently the sota result on the leaderboard of [*Stanford OGBN-MAG dataset*](https://ogb.stanford.edu/docs/nodeprop/#ogbn-mag). The code is [avaiable here](https://github.com/acbull/pyHGT/tree/master/ogbn-mag).
